...
export const kitchenPathOptions: PathOption[] = [
  ...
  },
  {
    ...
    description:
      "AI reads your kitchen and prefills details for a tighter, more accurate estimate.",
    icon: "camera",
    estimatedTime: "",
    features: [
      "Prefills cabinet type, counters, and flooring",
      "Estimates kitchen size and condition from photos",
      "Skip most manual questions after review",
      "You confirm or edit before we calculate",
    ],
