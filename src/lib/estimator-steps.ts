    ...
    questions: [
      {
        ...
        title: "What project are you planning?",
        choices: [
          { value: "roof",       icon: "🏠", label: "Roof Replacement",   desc: "Avg $16,650" },
          { value: "kitchen",    icon: "🍳", label: "Kitchen Remodel",     desc: "Avg $50,000" },
          { value: "bathroom",   icon: "🚿", label: "Bathroom Remodel",    desc: "Avg $19,000" },
          { value: "hvac",       icon: "❄️", label: "HVAC System",         desc: "Avg $8,250"  },
          { value: "windows",    icon: "🪟", label: "Windows",             desc: "Avg $12,500" },
          { value: "flooring",   icon: "🪵", label: "Flooring",            desc: "Avg $7,500"  },
          { value: "painting",   icon: "🖌️", label: "Painting",            desc: "Avg $4,500"  },
          { value: "solar",      icon: "☀️", label: "Solar Panels",        desc: "Avg $25,000" },
          { value: "deck",       icon: "🌿", label: "Deck / Patio",        desc: "Avg $13,000" },
          { value: "plumbing",   icon: "🔧", label: "Plumbing",            desc: "Avg $6,000"  },
          { value: "electrical", icon: "⚡", label: "Electrical",          desc: "Avg $8,000"  },
        ],
      },
    ],
  },
