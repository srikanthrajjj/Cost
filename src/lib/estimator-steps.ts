...
export interface Choice {
  ...
  desc?: string;
  image?: string;
  /** When true, card shows waitlist UI instead of selecting the project */
  comingSoon?: boolean;
}
    ...
    questions: [
      {
        ...
        choices: [
          ...
          { value: "hvac", icon: "/Air Conditioner.svg", label: "HVAC", desc: "Avg $8,250" },
          ...
          { value: "solar", icon: "/Solar Panel.svg", label: "Solar", desc: "Avg $25,000" },
        ],
      },
    ],
  },
  ...
  // ── Step 4d: HVAC details
  {
    ...
    questions: [
      ...
      },
      {
        ...
        info: "Leaky or undersized ducts can cut efficiency and raise install cost. Mini-splits usually do not need existing ducts.",
        choices: [
          { value: "good", icon: "✅", label: "Good", desc: "Keep existing ducts" },
          { value: "repair", icon: "🔧", label: "Needs repair", desc: "Seal or fix sections" },
      ...
      },
      {
        ...
        info: "Higher SEER and AFUE ratings cost more upfront but can lower monthly energy bills. Ask contractors which rebate programs apply in your area.",
        choices: [
    ...
    questions: [
      {
        ...
        info: "Count every window you plan to replace, including bathrooms and basement windows. Bay or picture windows still count as one opening unless you are replacing each section separately.",
        placeholder: "10",
        min: 1,
        max: 60,
        step: 1,
      ...
      {
        id: "windowInstallType",
        type: "select-grid",
        title: "Install method",
        info: "Retrofit (insert) windows sit in the existing frame and usually cost less. Full-frame replacement removes the old frame and often improves weather sealing, but costs more.",
        choices: [
          { value: "retrofit", icon: "📐", label: "Retrofit / insert", desc: "Lower cost, faster" },
          {
            value: "full-frame",
            icon: "🧱",
            label: "Full-frame",
            desc: "Remove old frame, best seal",
          },
        ],
      },
      {
        id: "windowStyle",
        type: "select-grid",
        title: "Main window style",
        info: "Style affects labor and hardware cost. Mixed styles are common on older homes. Pick the style that covers most of your openings.",
        choices: [
          { value: "double-hung", icon: "↕️", label: "Double-hung", desc: "Most common" },
          { value: "casement", icon: "↔️", label: "Casement", desc: "Crank open" },
          { value: "picture", icon: "🖼️", label: "Picture / fixed", desc: "No open sash" },
          { value: "mixed", icon: "🔀", label: "Mixed styles", desc: "Several types" },
        ],
      },
    ],
  },
  ...
  // ── Step 4f: Flooring
  {
    ...
    questions: [
      ...
      },
      {
        ...
        info: "Tear-out and disposal add labor and haul-away fees. Glue-down floors and tile take longer to remove than floating floors or carpet.",
        optional: true,
      },
      {
        id: "flooringPrep",
        type: "select-grid",
        title: "Subfloor prep needed?",
        info: "Uneven, soft, or damaged subfloors need leveling, patching, or replacement before new flooring goes down. More prep means higher labor cost.",
        choices: [
          { value: "minimal", icon: "✅", label: "Minimal", desc: "Mostly ready" },
          { value: "moderate", icon: "🔧", label: "Moderate", desc: "Leveling or patching" },
          { value: "major", icon: "⚠️", label: "Major", desc: "Replace damaged areas" },
        ],
      },
      {
        id: "flooringQuality",
        ...
        info: "Within each material, product line changes price. Basic covers entry-level stock. Premium covers thicker wear layers, better warranties, or designer lines.",
        choices: [
          { value: "basic", icon: "📦", label: "Basic", desc: "Budget-friendly" },
          { value: "standard", icon: "⭐", label: "Standard", desc: "Most common" },
          { value: "premium", icon: "💎", label: "Premium", desc: "Top of line" },
        ],
      },
    ],
  },
  ...
  // ── Step 4h: Deck
  {
    ...
    questions: [
      ...
      },
      {
        ...
        info: "Measure length times width of the deck surface. Include stairs and landings if they are part of the new build.",
        placeholder: "300",
        min: 50,
        max: 3000,
        step: 25,
      ...
      },
      {
        ...
        type: "select-grid",
        title: "Deck height",
        info: "Elevated decks need more framing, footings, and railings, which raises cost compared with a low platform near grade.",
        choices: [
          { value: "ground", icon: "🌱", label: "Near grade", desc: "Low platform" },
          { value: "elevated", icon: "🪜", label: "Elevated", desc: "Stairs and railings" },
        ],
      },
      {
        id: "deckRailing",
        type: "toggle",
        title: "Include railings?",
        info: "Code usually requires railings on elevated decks. Cable, glass, and decorative systems cost more than basic wood or composite rails.",
        optional: true,
      },
    ],
  },
  ...
  // ── Step 4i: Plumbing
  {
    ...
    questions: [
      ...
      },
      {
        id: "plumbingScope",
        type: "select-grid",
        title: "How much of the home?",
        info: "Localized work covers one bathroom or kitchen. Whole-home work spans multiple rooms and usually costs more for access, materials, and restoration.",
        choices: [
          { value: "localized", icon: "📍", label: "One area", desc: "Single room or fixture" },
          { value: "whole-home", icon: "🏠", label: "Whole home", desc: "Multiple rooms" },
        ],
      },
    ],
  },
  ...
  // ── Step 4j: Electrical
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "select-grid",
        title: "Project scope",
        info: "Limited work covers a few circuits or a single panel. Whole-home work includes more labor, drywall access, and inspection time.",
        choices: [
          { value: "limited", icon: "📍", label: "Limited", desc: "Few circuits or one panel" },
          { value: "whole-home", icon: "🏠", label: "Whole home", desc: "Major electrical work" },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        info: "Interior painting is priced mainly by room count and prep. Exterior painting depends on home size, stories, and surface condition.",
        choices: [
      ...
      },
      {
        ...
        info: "Count bedrooms, living areas, hallways, and bathrooms you plan to paint. Closets usually count as half a room if included.",
        placeholder: "5",
        min: 1,
        max: 30,
        step: 1,
        unit: "rooms",
        optional: true,
        showIf: (a) => a.paintingScope === "interior" || a.paintingScope === "both",
      },
      {
        id: "paintingQuality",
        type: "select-grid",
        title: "Paint quality",
        info: "Better paint covers with fewer coats and lasts longer outdoors. Premium lines cost more per gallon but can reduce labor on multi-coat jobs.",
        choices: [
          { value: "standard", icon: "📦", label: "Standard", desc: "Good contractor grade" },
          { value: "premium", icon: "💎", label: "Premium", desc: "Longer warranty finish" },
        ],
      },
    ],
  },
