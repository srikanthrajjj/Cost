...
const STATIC_PATHS: { path: string; priority: string }[] = [
  ...
  { path: "/guides/how-to-compare-contractor-quotes", priority: "0.85" },
  { path: "/guides/allowances-and-change-orders", priority: "0.85" },
  { path: "/guides/contractor-payment-schedules", priority: "0.85" },
  { path: "/guides/missing-scope-in-contractor-quotes", priority: "0.85" },
  { path: "/guides/kitchen-quote-review", priority: "0.85" },
  { path: "/guides/what-to-do-after-getting-contractor-quotes", priority: "0.85" },
  ...
  { path: "/guides/roof-replacement-cost-by-state", priority: "0.8" },
  { path: "/guides/roof-replacement-cost-by-city", priority: "0.8" },
  { path: "/guides/roof-replacement-timeline", priority: "0.75" },
  { path: "/guides/roof-permits", priority: "0.75" },
  { path: "/guides/roof-financing", priority: "0.75" },
  { path: "/guides/roof-insurance-claims", priority: "0.75" },
  { path: "/guides/can-insurance-cover-roof-replacement", priority: "0.75" },
  { path: "/guides/roof-quote-review", priority: "0.8" },
  { path: "/guides/quartz-countertop-cost", priority: "0.8" },
  { path: "/guides/cabinet-install-labor-cost", priority: "0.8" },
  { path: "/guides/is-30k-enough-for-kitchen-remodel", priority: "0.8" },
  { path: "/guides/solar-panel-cost", priority: "0.85" },
  { path: "/guides/ev-charger-installation-cost", priority: "0.85" },
  { path: "/guides/smart-thermostat-installation-cost", priority: "0.8" },
