    ...
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 md:py-16">
        ...
        <nav className="flex items-center gap-2 text-xs text-muted-foreground mb-8">
          ...
          <span>/</span>
          <a href="/estimate" className="hover:text-ink transition">
            Cost Estimator
          </a>
          <span>/</span>
        ...
        <div className="rounded-2xl overflow-hidden mb-10 aspect-[21/9]">
          <img
            src={project.image}
            alt={`${project.name} project in progress — typical residential home improvement work`}
        ...
        <div className="rounded-2xl border border-border bg-white p-6 md:p-8 mb-10">
          ...
          <div className="mt-8 pt-6 border-t border-border text-center">
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Free. No signup. Personalized to your ZIP code.
            </p>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-muted-foreground mb-5">
            Understanding where your money goes helps you evaluate quotes and negotiate with
            contractors. Here's how a typical {project.name.toLowerCase()} budget breaks down:
          </p>
              ...
              <tbody>
                {project.costBreakdown.map((row, i) => (
                  <tr
                    key={row.item}
                    className={
                      i < project.costBreakdown.length - 1 ? "border-b border-border/50" : ""
                    }
                  >
                    <td className="px-5 py-3 text-sm text-ink">{row.item}</td>
                    <td className="px-5 py-3 text-sm font-semibold text-ink text-right">
                      {row.pct}
                    </td>
                  </tr>
                ))}
          ...
          <div className="mt-4 p-4 rounded-lg bg-accent/5 border border-accent/20">
            ...
            <p className="text-sm text-muted-foreground">
              Any contractor quote that doesn't break costs down into at least these categories is a
              red flag. An itemized quote protects you from hidden charges and makes it possible to
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-muted-foreground mb-5">
            Knowing the process helps you plan around disruptions, ask better questions, and catch
            problems early. Here's what to expect from start to finish:
          </p>
            ...
            {[
              {
                ...
                desc: `A licensed contractor inspects your property, takes measurements, and discusses your goals. They should provide a written, itemized estimate within 2-3 days, not a verbal ballpark on the spot.`,
              },
              {
                step: "2",
                title: "Material Selection & Permits",
                desc: `You choose materials based on budget, durability, and aesthetics. Your contractor handles permit applications. This stage takes 1-2 weeks depending on your municipality.`,
              },
              {
                step: "3",
                title: "Preparation & Demolition",
                desc: `The work area is protected and old materials are removed. This is when hidden issues (rot, water damage, structural problems) typically surface. Expect a potential change order here.`,
              },
              {
                step: "4",
                title: "Installation",
                desc: `New materials are installed according to manufacturer specifications and local building codes. Quality contractors document their work with photos at each stage.`,
              },
              {
                step: "5",
                title: "Inspection & Walkthrough",
                desc: `A final inspection ensures everything meets code. You walk the completed project with your contractor against the original written scope before releasing final payment.`,
              },
            ].map((s) => (
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-muted-foreground mb-5">
            These are the most common ways a contractor quote quietly costs you more than it should.
            If you spot any of these, ask questions before signing:
          </p>
          <div className="space-y-3">
            {[
              {
                flag: "No itemized breakdown",
                desc: "A single lump-sum number makes it impossible to compare quotes or know what you're paying for.",
              },
              {
                flag: "Large upfront deposit (50%+)",
                desc: "Reputable contractors ask for 10-30% down, not half the project cost before work begins.",
              },
              {
                flag: "No mention of permits",
                desc: "If the quote is silent on permits, ask who's responsible. It should be the contractor.",
              },
              {
                flag: "Pressure to sign today",
                desc: "Legitimate professionals don't need you to commit on the spot. Take time to compare.",
              },
              {
                flag: "Vague material specifications",
                desc: '"Standard grade" or "builder quality" means nothing. Demand specific brands and model numbers.',
              },
            ].map((item) => (
              <div
                key={item.flag}
          ...
          <div className="mt-5 p-4 rounded-lg bg-accent/5 border border-accent/20">
            ...
            <p className="text-sm text-muted-foreground">
              Get at least 3 written quotes from licensed, insured contractors. Upload them to our{" "}
              <a href="/quote-analyzer" className="text-accent font-semibold underline">
                Quote Analyzer
              </a>{" "}
              to instantly flag missing scope, overpricing, and red flags.
            </p>
          </div>
        </section>
        ...
        {/* Customer Reviews */}
        <section className="mb-12">
          <h2 className="font-display text-2xl font-bold text-ink mb-5">What Homeowners Say</h2>
        ...
        <section className="mb-12 pt-8 border-t border-border">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {PROJECT_CONFIGS.filter((p) => p.slug !== project.slug)
              .slice(0, 4)
              .map((p) => (
                <a
                  key={p.slug}
        ...
        <div className="text-center py-10 rounded-2xl border border-border bg-white">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-md mx-auto">
            Answer a few questions about your project and get an accurate, location-based cost
