            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="w-44 rounded-xl border border-border bg-white shadow-xl p-2">
                  {[{name:"Roofing",href:"/roof-replacement-cost"},{name:"Kitchen",href:"/kitchen-remodel-cost"},{name:"Bathroom",href:"/bathroom-remodel-cost"},{name:"HVAC",href:"/hvac-installation-cost"},{name:"Windows",href:"/window-replacement-cost"},{name:"Flooring",href:"/flooring-cost"},{name:"Solar",href:"#"},{name:"Foundation",href:"#"}].map((item) => (
