...
export const Route = createFileRoute("/topics/windows")({
  component: WindowsTopicPage,
  head: () => ({
    meta: [
      { title: "Window costs topic hub | CostReno" },
      {
        name: "description",
        content:
          "Window replacement cost guides and local city pages to help you plan energy upgrades before hiring.",
      },
      { property: "og:title", content: "Window costs topic hub | CostReno" },
      { property: "og:url", content: "https://www.costreno.com/topics/windows" },
      { property: "og:image", content: DEFAULT_OG_IMAGE },
      { name: "robots", content: "index, follow" },
    ],
    links: [{ rel: "canonical", href: "https://www.costreno.com/topics/windows" }],
  }),
});

const LINKS = [
  {
    title: "Window replacement cost landing",
    href: "/window-replacement-cost",
    desc: "National window replacement ranges, breakdowns, and FAQs.",
  },
  {
    title: "Window replacement guide",
        ...
        <section className="py-16 md:py-20 border-b border-border/60">
          <div className="container-x max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Plan a window replacement with national guides and city-level pricing context.
            </p>
          </div>
        </section>
