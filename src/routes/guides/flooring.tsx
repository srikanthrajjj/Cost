...
const SCOPE_COSTS = [
  { scope: "LVP (Luxury Vinyl Plank)", range: "$3–$7/sq ft", timeline: "1–2 days", includes: "Material, underlayment, installation" },
  { scope: "Hardwood", range: "$6–$12/sq ft", timeline: "2–4 days", includes: "Solid or engineered, sanding, finishing" },
  { scope: "Tile", range: "$5–$15/sq ft", timeline: "2–4 days", includes: "Porcelain or ceramic, mortar, grout" },
  { scope: "Carpet", range: "$2–$5/sq ft", timeline: "1 day", includes: "Carpet, padding, tack strips, seaming" },
  { scope: "Laminate", range: "$2–$5/sq ft", timeline: "1–2 days", includes: "Material, underlayment, transitions" },
];
...
const PROCESS_STEPS = [
  { step: "1", title: "Material Selection & Measurement", desc: "Choose flooring type based on room usage, moisture exposure, and budget. Professional measurement determines exact square footage needed (typically add 10% for waste and cuts)." },
  { step: "2", title: "Subfloor Preparation", desc: "Existing flooring is removed. Subfloor is inspected, leveled, and repaired as needed. Moisture testing is performed for concrete slabs. Underlayment is installed where required." },
  { step: "3", title: "Acclimation", desc: "Hardwood and some other materials need to acclimate to your home's temperature and humidity for 48–72 hours before installation. This prevents expansion or contraction after install." },
  { step: "4", title: "Installation", desc: "Flooring is installed following manufacturer guidelines. This includes proper expansion gaps, staggered seams, and appropriate adhesive or fastening methods for the material type." },
  { step: "5", title: "Finishing & Transitions", desc: "Transition strips between rooms, baseboards, and quarter-round trim are installed. Any sanding and finishing for hardwood. Final cleanup and furniture move-back." },
];
    ...
    <div className="min-h-screen bg-white">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Flooring", item: "https://costreno.com/guides/flooring" },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-6">
        <nav className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span>
          <a href="/guides" className="hover:text-ink transition">Flooring</a>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-ink">Reviewed by Flooring Industry Experts</span>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-border bg-white p-6 md:p-8 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="font-display text-xl md:text-2xl font-bold text-ink">$3,000–$15,000</div>
          ...
          <div>
            ...
            <section id="signs" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Not sure if your floors need replacement or just a refresh? Here are the most common signs that it's time for new flooring:
              </p>
            ...
            <section id="costs" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Costs vary significantly based on material choice and installation complexity. Below is a comparison of typical flooring costs (materials + installation):
              </p>
            ...
            <section id="materials" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                Each flooring material has strengths and ideal use cases. Here's what to know about the most popular options:
              </p>
              <div className="space-y-6">
                <div className="rounded-xl border border-border bg-white p-5">
                  <h3 className="font-display text-lg font-bold text-ink mb-2">Luxury Vinyl (LVP/LVT)</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    The fastest-growing flooring category. Luxury vinyl plank (LVP) is 100% waterproof, extremely durable, and available in realistic wood and stone looks. Easy click-lock installation makes it DIY-friendly. Ideal for kitchens, bathrooms, basements, and high-traffic areas.
                  </p>
                  <div className="flex flex-wrap gap-3 text-xs">
                    <span className="px-3 py-1 rounded-full bg-accent/10 text-accent font-medium">$3–$7/sq ft installed</span>
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Lifespan: 15–25 years</span>
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Best for: Whole home</span>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    The gold standard in flooring that never goes out of style. Available in solid (3/4" thick, can be refinished many times) and engineered (plywood core, more stable). Oak, maple, and hickory are most popular. Not recommended for bathrooms or basements due to moisture sensitivity.
                  </p>
                  <div className="flex flex-wrap gap-3 text-xs">
                    <span className="px-3 py-1 rounded-full bg-accent/10 text-accent font-medium">$6–$12/sq ft installed</span>
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Lifespan: 30–100+ years</span>
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Best for: Living areas</span>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <div className="flex flex-wrap gap-3 text-xs">
                    ...
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Lifespan: 50+ years</span>
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Best for: Wet areas</span>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <div className="flex flex-wrap gap-3 text-xs">
                    ...
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Lifespan: 5–15 years</span>
                    <span className="px-3 py-1 rounded-full bg-muted text-muted-foreground">Best for: Bedrooms</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section id="contractor" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Quality installation is essential for flooring performance and longevity. Use this checklist to vet candidates:
              </p>
            ...
            <section id="permits" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Flooring installation rarely requires permits, but there are some exceptions. Here's what you need to know:
              </p>
              <div className="space-y-4">
                <div className="rounded-xl border border-border bg-white p-5">
                  <h3 className="font-display text-base font-bold text-ink mb-2">When is a permit required?</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Standard flooring replacement does not require permits in most areas. However, permits may be required if you're adding radiant floor heating (electrical permit), modifying the subfloor structure, or if the project is part of a larger renovation that requires permits.
                  </p>
                </div>
                <div className="rounded-xl border border-border bg-white p-5">
                  <h3 className="font-display text-base font-bold text-ink mb-2">HOA considerations</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    If you live in a condo or HOA community, check your bylaws. Many require board approval before changing flooring type (especially from carpet to hard surfaces) and may have sound-rating requirements (STC/IIC ratings) for multi-story buildings.
                  </p>
                </div>
                <div className="rounded-xl border border-border bg-white p-5">
                  <h3 className="font-display text-base font-bold text-ink mb-2">Asbestos testing</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Homes built before 1980 may have asbestos in vinyl flooring, adhesives, or underlayment. Testing before removal is recommended (and required in some areas). Professional abatement adds $2–$5/sq ft if asbestos is found.
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-amber-50 border border-amber-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-ink mb-1">Warning: Moisture testing is critical</p>
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Installing flooring over a concrete slab without proper moisture testing can lead to mold, adhesive failure, and warping. Ensure your installer performs a calcium chloride or relative humidity test before installation on any concrete surface.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-display text-base font-bold text-ink">Calculate Your Flooring Installation Cost</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                  Get a personalized estimate based on your ZIP code, square footage, and material preferences. Free, no signup required.
                </p>
                <a
              ...
              <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-display text-base font-bold text-ink">Need Help Reviewing Your Flooring Quote?</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                  Upload your flooring installation quote and get instant analysis on pricing, scope, and potential red flags.
                </p>
                <a
                  href="/quote-analyzer"
              ...
              <div className="rounded-2xl border border-border bg-white p-6">
                ...
                <div className="space-y-3">
                  <a href="/estimate?project=flooring" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-accent transition">
