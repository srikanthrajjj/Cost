    ...
    <div className="min-h-screen bg-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Learn how to identify inflated contractor quotes. 12 red flags that signal overpricing, hidden fees, and scope manipulation.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "FAQPage",
            mainEntity: FAQ_ITEMS.map((faq) => ({ "@type": "Question", name: faq.q, acceptedAnswer: { "@type": "Answer", text: faq.a } })),
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Guides", item: "https://costreno.com/guides" },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-6">
        <nav className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span>
          <a href="/guides" className="hover:text-ink transition">Guides</a>
          <span>/</span>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-10 md:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <span className="inline-block text-xs font-bold uppercase tracking-wider text-accent mb-4">Quote tips</span>
            ...
            <p className="mt-5 text-base text-muted-foreground leading-relaxed max-w-lg">
              Not every high quote means you're being overcharged. But certain patterns consistently signal that a contractor is padding their numbers. Learn to spot them before you sign.
            </p>
          ...
          <div className="rounded-2xl overflow-hidden aspect-[4/3]">
            <img src={cmpRoof} alt="Contractor reviewing a renovation quote" className="w-full h-full object-cover" loading="eager" />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1.5 mb-2">
                ...
                <span className="text-xs font-semibold text-muted-foreground uppercase">Typical markup</span>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1.5 mb-2">
                ...
                <span className="text-xs font-semibold text-muted-foreground uppercase">Quotes needed</span>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1.5 mb-2">
                ...
                <span className="text-xs font-semibold text-muted-foreground uppercase">Labor share</span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10">
          <div>
            ...
            <div className="rounded-xl border border-border bg-white p-6 mb-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {TABLE_OF_CONTENTS.map((item, i) => (
                  <a key={item.id} href={`#${item.id}`} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-accent transition py-1">
                    <span className="w-5 h-5 rounded-full bg-accent/10 flex items-center justify-center text-[10px] font-bold text-accent shrink-0">{i + 1}</span>
                    {item.label}
                  </a>
                ))}
              </div>
            ...
            <section id="why-quotes-inflated" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">Why contractors inflate quotes</h2>
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                Most contractors are honest professionals. But the industry's lack of pricing transparency creates opportunities for those who aren't. Here's why inflation happens:
              </p>
              <div className="space-y-3">
                {[
                  { title: "No standard pricing", desc: "Unlike retail products, renovation services have no published price list. Each contractor sets their own rates, making it hard for homeowners to know what's fair." },
                  { title: "Information asymmetry", desc: "Contractors know material costs, labor rates, and project timelines. Most homeowners don't. This gap makes it easy to pad numbers without detection." },
                  { title: "Fear-based selling", desc: "Some contractors inflate quotes after 'discovering' urgent problems during inspection, creating pressure to approve expensive solutions immediately." },
                  { title: "Low accountability", desc: "Homeowners rarely compare their final costs against what was fair market value. Without feedback loops, inflated pricing goes unchallenged." },
                ].map((item) => (
            ...
            <section id="red-flags" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">12 red flags of an inflated quote</h2>
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Look for these warning signs in any contractor quote you receive. The more flags present, the more likely the quote is inflated:
              </p>
              <div className="space-y-3">
                {RED_FLAGS.map((flag, i) => (
                  <div key={flag.title} className="flex items-start gap-3 p-4 rounded-xl border border-border bg-white">
            ...
            <section id="pricing-comparison" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">How to compare pricing</h2>
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                The most reliable way to identify an inflated quote is to compare it against other bids and market data:
              </p>
              <div className="space-y-3">
                {[
              ...
              <div className="mt-5 p-4 rounded-xl bg-accent/5 border border-accent/20">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Create a simple spreadsheet with columns for each bid. List every line item down the rows. This makes it immediately obvious when one contractor is charging 2x to 3x what others charge for the same item.
                </p>
              </div>
            </section>
            ...
            <section id="common-tactics" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">Common inflation tactics</h2>
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Understanding how inflation happens helps you spot it. Here are the most common tactics and how to defend against them:
              </p>
              <div className="rounded-xl border border-border bg-white overflow-hidden">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border bg-muted/30">
                      <th className="text-left text-xs font-semibold text-muted-foreground uppercase px-5 py-3">Tactic</th>
                      <th className="text-left text-xs font-semibold text-muted-foreground uppercase px-5 py-3 hidden sm:table-cell">How it works</th>
                      <th className="text-left text-xs font-semibold text-muted-foreground uppercase px-5 py-3">Defense</th>
                    </tr>
                  </thead>
                  <tbody>
                    {COMMON_TACTICS.map((row, i) => (
                      <tr key={row.tactic} className={i < COMMON_TACTICS.length - 1 ? "border-b border-border/50" : ""}>
                        <td className="px-5 py-3 text-sm font-medium text-ink align-top">{row.tactic}</td>
                        <td className="px-5 py-3 text-sm text-muted-foreground hidden sm:table-cell align-top">{row.how}</td>
                        <td className="px-5 py-3 text-sm text-muted-foreground align-top">{row.defense}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <section id="what-fair-quote-looks-like" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">What a fair quote looks like</h2>
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
            ...
            <section id="how-to-negotiate" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">How to negotiate effectively</h2>
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                If you've identified inflation in a quote, here's how to approach the conversation:
              </p>
              <div className="space-y-3">
                {[
                  { title: "Lead with data, not emotions", desc: "Show specific comparable prices from other bids or market research. 'I received two other quotes at $X for the same scope' is more effective than 'your price is too high.'" },
                  { title: "Negotiate line items, not the total", desc: "Instead of asking for a blanket discount, identify specific overpriced items. 'I see labor at $85/hour when the local average is $55 to $65. Can we discuss this line?'" },
                  { title: "Offer trade-offs", desc: "Suggest reducing scope, choosing alternative materials, scheduling in the off-season, or bundling multiple projects. Give the contractor a way to reduce price without feeling they're losing." },
                  { title: "Be willing to walk away", desc: "The strongest negotiating position is genuine willingness to choose another contractor. Don't bluff. Actually have backup options ready." },
                  { title: "Get the revised quote in writing", desc: "Any agreed-upon price changes must be documented in the updated written quote before you sign. Verbal promises have no weight." },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 p-4 rounded-xl border border-border bg-white">
                    <CheckCircle2 className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                    <div>
            ...
            <section id="costreno-ai" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-4">How CostReno AI detects inflation</h2>
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                CostReno's AI quote analyzer automates the detection of inflated pricing:
              </p>
              <div className="space-y-3 mb-5">
                {[
                  { title: "Line-by-line benchmarking", desc: "Every item in your quote is compared against regional market rates to highlight anything priced above fair range." },
                  { title: "Labor ratio analysis", desc: "Flags quotes where labor exceeds normal percentages for that project type without justification." },
                  { title: "Missing scope detection", desc: "Identifies common items that should be in the quote but aren't, predicting likely change orders." },
                  { title: "Vague language flagging", desc: "Highlights open-ended phrases like 'as needed' or 'allowance' that can lead to cost overruns." },
                  { title: "Savings calculation", desc: "Shows the dollar amount you could save by negotiating overpriced items down to fair market value." },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 p-4 rounded-xl border border-border bg-white">
                    <CheckCircle2 className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                    <div>
              ...
              <div className="rounded-xl border border-border bg-white p-5 text-center">
                <p className="text-sm text-muted-foreground mb-4">
                  Upload your contractor quote to CostReno and get an instant analysis showing which items are overpriced, what's missing, and how much you could save.
                </p>
                <a href="/quote-analyzer" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-accent text-white text-sm font-bold hover:bg-accent/90 transition">
            ...
            <section id="faq" className="mb-12">
              <h2 className="font-display text-2xl font-bold text-ink mb-5">Frequently asked questions</h2>
              <div className="space-y-3">
                {FAQ_ITEMS.map((faq, i) => (
                  <div key={i} className="rounded-xl border border-border bg-white overflow-hidden">
                    <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="flex items-center justify-between w-full px-5 py-4 text-left hover:bg-muted/20 transition">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {RELATED_GUIDES.map((guide) => (
                  <a key={guide.href} href={guide.href} className="flex items-center gap-3 p-4 rounded-xl border border-border bg-white hover:border-accent/40 hover:shadow-md transition">
            ...
            <div className="sticky top-24 space-y-6">
              <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-display text-base font-bold text-ink">Got a quote you're unsure about?</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                  Upload it and our AI will flag overpriced items, missing scope, and savings opportunities instantly.
                </p>
                <a href="/quote-analyzer" className="flex items-center justify-center gap-2 w-full px-5 py-3 rounded-xl bg-accent text-white text-sm font-bold hover:bg-accent/90 transition shadow-sm">
                  Analyze my quote <ArrowRight className="h-4 w-4" />
                </a>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-white p-6">
                ...
                <div className="space-y-3">
                  {RELATED_GUIDES.map((guide) => (
                    <a key={guide.href} href={guide.href} className="flex items-center gap-3 text-sm text-muted-foreground hover:text-accent transition">
