...
const SCOPE_COSTS = [
  {
    scope: "Half Bath Update",
    range: "$3,000–$8,000",
    timeline: "3–5 days",
    includes: "New vanity, toilet, paint, fixtures",
  },
  {
    scope: "Standard Remodel",
    range: "$8,000–$20,000",
    timeline: "2–3 weeks",
    includes: "New tile, vanity, fixtures, lighting",
  },
  {
    scope: "Master Bath Renovation",
    range: "$20,000–$35,000",
    timeline: "3–4 weeks",
    includes: "Layout changes, shower/tub, heated floors",
  },
  {
    scope: "Luxury Bath",
    range: "$35,000+",
    timeline: "4–6 weeks",
    includes: "Custom everything, premium finishes, spa features",
  },
];
...
const PROCESS_STEPS = [
  ...
  },
  {
    step: "2",
    title: "Demolition",
    desc: "Existing tile, vanity, tub/shower, and fixtures are removed. Subfloor and walls are inspected for water damage or mold.",
  },
  {
    step: "3",
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-ink">
                Reviewed by Bathroom Design Experts
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <section id="costs" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                ...
                of typical bathroom remodel budgets:
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    Tile is the most impactful material in a bathroom remodel. Porcelain and ceramic
                    are the most popular for floors and showers due to their water resistance and
                    durability. Natural stone (marble, travertine) adds luxury but requires more
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    Your vanity is the focal point of the bathroom. Options range from stock
                    vanities (pre-built, standard sizes) to semi-custom and fully custom floating or
                    freestanding designs. Consider storage needs, countertop material, and sink
                    style.
                  </p>
                  <div className="flex flex-wrap gap-3 text-xs">
                    <span className="px-3 py-1 rounded-full bg-accent/10 text-accent font-medium">
                ...
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    Fixtures include faucets, showerheads, towel bars, and toilet. Upgrading to
                    modern fixtures can transform a bathroom's look without major construction.
                    Matte black and brushed gold are trending finishes, while chrome remains a
                    classic budget-friendly choice.
                  </p>
                  <div className="flex flex-wrap gap-3 text-xs">
                    <span className="px-3 py-1 rounded-full bg-accent/10 text-accent font-medium">
                      Budget: $500–$1,500
            ...
            <section id="process" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                ...
                expectations. Here's a typical bathroom remodel timeline:
              </p>
            ...
            <section id="contractor" className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                ...
                quality matters. Use this checklist to vet candidates:
              </p>
            ...
            <section id="permits" className="mb-12">
              ...
              <div className="space-y-4">
                <div className="rounded-xl border border-border bg-white p-5">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Permits are required for moving or adding plumbing (relocating toilet, shower,
                    or sink), electrical work (new circuits, GFCI outlets), and structural
                    modifications. Cosmetic updates like new tile, paint, vanity swap (same
                    location), and fixture replacement typically don't require permits.
                  </p>
                </div>
                <div className="rounded-xl border border-border bg-white p-5">
                  <h3 className="font-display text-base font-bold text-ink mb-2">Permit costs</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Bathroom remodel permits typically cost $100–$800 depending on your municipality
                    and the scope of work. Plumbing and electrical permits may be separate. Your
                    contractor should include these costs in their estimate.
                  </p>
                </div>
                <div className="rounded-xl border border-border bg-white p-5">
                  <h3 className="font-display text-base font-bold text-ink mb-2">Inspections</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Inspections occur after rough-in plumbing and electrical (before walls are
                    closed) and a final inspection after completion. Waterproofing inspections may
                    also be required before tile installation.
                  </p>
                </div>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
                ...
                <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                  Get a personalized estimate based on your ZIP code, bathroom size, and material
              ...
              <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
                ...
                <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                  Upload your bathroom remodel quote and get instant analysis on pricing, scope, and
                  potential red flags.
                </p>
                <a
                  href="/quote-analyzer"
